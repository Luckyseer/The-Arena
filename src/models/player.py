...
class Player:
    ...
    def __init__(self, item_data, name='Zen', health=100, mana=50, strength=10, magic=20, defence=10, luck=2):
        ...
        self.add_stre = self.item_data['weapons'][self.cur_weapon]['atk'] + self.item_data['armours'][self.cur_armour]['atk'] + \
            self.item_data['accessories'][self.cur_accessory]['atk']
        self.add_defe = self.item_data['weapons'][self.cur_weapon]['def'] + self.item_data['armours'][self.cur_armour]['def'] + \
            self.item_data['accessories'][self.cur_accessory]['def']
        self.add_mag = self.item_data['weapons'][self.cur_weapon]['mag'] + self.item_data['armours'][self.cur_armour]['mag'] + \
            self.item_data['accessories'][self.cur_accessory]['mag']
        self.add_luck = luck
